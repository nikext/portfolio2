...
export const roles: Role[] = [
  {
    ...
    stack: ['Python', 'SQL', 'Google Cloud', 'Terraform', 'dbt', 'GKE', 'BigQuery', 'Claude Code', 'Gemini'],
  },
  {
    id: 'vad',
    ...
    stack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Node.js', 'Express', 'PostgreSQL', 'NextAuth.js', 'Render'],
  },
  {
    id: 'floatz',
    company: 'floatz.ai',
