...
- The look is cyan on blue-black and deliberately different from the older orange nikext.dev site. Keep the accent single and the type stack (Space Grotesk, Inter, JetBrains Mono) self-hosted.
